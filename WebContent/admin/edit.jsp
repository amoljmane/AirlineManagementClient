...
<%
	UserBean emply = (UserBean) hs.getAttribute("employeeShowed");
%>
...
$(function() {
	...
	var input = function(){
		...
		var ssn = $('#ssn').val("<%=emply.getEmployeeBean().getSsn()%>");
...
<body onload="input()">
	<div class="container">
		...
		<form class="form-horizontal c" role="form"
			action="../EmployeeServlet?flag=editEmployee&person_id=<%=emply.getEmployeeBean().getPerson_id() %>" method="post">
